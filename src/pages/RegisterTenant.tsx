...
const RegisterTenant: React.FC = () => {
  ...
  if (isSuccess) {
    const subdomainUrl = `https://${formData.domain_url}.carepointhms.com`;
    return (
        ...
        <div className="max-w-md w-full bg-white dark:bg-slate-900 p-12 rounded-3xl shadow-xl text-center border border-slate-100 dark:border-slate-800">
          ...
          <div className="space-y-3">
            ...
            <button 
              ...
              className="w-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-600 dark:text-slate-300 rounded-xl py-3 font-bold transition-all"
            >
              Back to Main Login
            </button>
          </div>
